...
Most of the roles used in this playbook are from the [this galaxy tutorial](https://galaxyproject.github.io/training-material/topics/admin/tutorials/ansible-galaxy/tutorial.html).
